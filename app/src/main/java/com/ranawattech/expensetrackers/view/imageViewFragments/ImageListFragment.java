package com.ranawattech.expensetrackers.view.imageViewFragments;
...
import com.ranawattech.expensetrackers.adapter.ImageGridRecyclerAdapter;
import com.ranawattech.expensetrackers.model.ImageDetails;
import com.ranawattech.expensetrackers.viewmodel.ImageActivityViewModel;
...
public class ImageListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup parent, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragments_image_list, parent, false);
        getImagesList();
